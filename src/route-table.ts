...
export const OLD_ROUTES_TABLE_NAME = 'ROUTES_OLD';
...
export function getSwapTablesQuery() {
  return /* sql */ `
    DROP TABLE IF EXISTS ${OLD_ROUTES_TABLE_NAME};

    ALTER TABLE IF EXISTS ${ROUTES_TABLE_NAME} RENAME TO ${OLD_ROUTES_TABLE_NAME};
